export default {
	render: (container:HTMLElement) => {
		container.innerHTML = `
			<div class="flex">
				<div class="flex flex-col gap-4 w-screen sm:w-[30vw] sm:min-w-[300px] h-screen bg-[var(--bg-color)]">
					...
					<div class="sm:flex flex-col scroll-pr-4 pl-4 flex-1 overflow-y-auto styled-scrollbar">
						<div class="flex items-center gap-3 py-3 hover:bg-[var(--bg-hover)] hover:cursor-pointer border-b rounded-sm">
				...
				<div class="hidden bg-black sm:block sm:w-[70vw] h-screen">
