...
export default {
	render: (container: HTMLElement) => {
	  ...
	  <div class="flex flex-col items-center gap-8 max-w-md w-full p-8 rounded-2xl border border-pongcyan bg-slate-900 bg-opacity-60 backdrop-blur-md shadow-[0_0_10px_#00ffff]">
		...
		<div class="flex flex-col gap-6 w-full">
		  <div class="flex items-center gap-4 bg-slate-900 bg-opacity-50 p-4 rounded-lg border border-pongcyan shadow-[0_0_6px_#00ffff55]">
		...
		<div class="flex flex-col gap-2 items-center">
		  ...
		  <button class="continue-to-login mt-4 px-6 py-3 rounded-lg bg-pongcyan text-slate-300 hover:opacity-80 transition-all duration-200 shadow-[0_0_10px_#00ffff]">
