                ...
                <!-- Buttons will be inserted here -->
                    <button class="game-mode-btn max-[350px]:size-[120px] max-sm:size-[150px] max-sm:justify-center p-2 sm:p-8 border-none rounded-2xl group bg-gradient-to-br from-pongblue to-[rgba(100,100,255,0.8)] hover:from-[rgba(100,100,255,0.9)] hover:to-pongblue text-white flex max-sm:flex-col items-center gap-3 sm:gap-6 cursor-pointer transition-all duration-300 ease-in-out transform translate-y-0 shadow-md active:translate-y-0 animate-fade-up animate-once" data-route="/play/local-ai">
                        ...
                        <div class="flex flex-col gap-1 text-center sm:text-left">
                            <h2 class="max-[350px]:text-lg text-2xl">VS AI</h2>
                    ...
                    <button class="game-mode-btn max-[350px]:size-[120px] max-sm:size-[150px] max-sm:justify-center p-2 sm:p-8 border-none rounded-2xl group bg-gradient-to-br from-pongblue to-[rgba(100,100,255,0.8)] hover:from-[rgba(100,100,255,0.9)] hover:to-pongblue text-white flex max-sm:flex-col items-center gap-3 sm:gap-6 cursor-pointer transition-all duration-300 ease-in-out transform translate-y-0 shadow-md active:translate-y-0 animate-fade-up animate-once" data-route="/play/local-multi">
                        ...
                        <div class="flex flex-col gap-1 text-center sm:text-left">
                            <h2 class="max-[350px]:text-lg text-2xl">Local Multiplayer</h2>
                    ...
                    <button class="game-mode-btn max-[350px]:size-[120px] max-sm:size-[150px] max-sm:justify-center p-2 sm:p-8 border-none rounded-2xl group bg-gradient-to-br from-pongblue to-[rgba(100,100,255,0.8)] hover:from-[rgba(100,100,255,0.9)] hover:to-pongblue text-white flex max-sm:flex-col items-center gap-3 sm:gap-6 cursor-pointer transition-all duration-300 ease-in-out transform translate-y-0 shadow-md active:translate-y-0 animate-fade-up animate-once" data-route="/play/online-tournament">
                        ...
                        <div class="flex flex-col gap-1 text-center sm:text-left">
                            <h2 class="max-[350px]:text-lg text-2xl">Online Tournament</h2>
                    ...
                    <button class="game-mode-btn max-[350px]:size-[120px] max-sm:size-[150px] max-sm:justify-center p-2 sm:p-8 border-none rounded-2xl group bg-gradient-to-br from-pongblue to-[rgba(100,100,255,0.8)] hover:from-[rgba(100,100,255,0.9)] hover:to-pongblue text-white flex max-sm:flex-col items-center gap-3 sm:gap-6 cursor-pointer transition-all duration-300 ease-in-out transform translate-y-0 shadow-md active:translate-y-0 animate-fade-up animate-once" data-route="/play/online-multi">
                        ...
                        <div class="flex flex-col gap-1 text-center sm:text-left">
                            <h2 class="max-[350px]:text-lg text-2xl">Online Multiplayer</h2>
