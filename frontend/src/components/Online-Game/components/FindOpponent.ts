				...
				<div class="w-full h-full flex flex-col items-center justify-center gap-6 py-8">
					<div class="text-center">
						...
						<div class="flex items-center justify-center gap-4 mb-6 bg-black/40 p-6 border-2 border-pongcyan rounded-xl shadow-[0_0_15px_rgba(0,247,255,0.4)] animate-fade-up animate-once animate-duration-500">
							<div class="size-16 rounded-full bg-pongblue relative group transform transition-all duration-300 hover:scale-110">
	...
	container.querySelector("#cancel-search")!.addEventListener("click", () => {
		...
		container.innerHTML = `
			<div class="relative w-full h-[4rem] sm:h-[8rem] flex items-center justify-center">
				<i id="icon-friends" class="fa-solid fa-users max-[460px]:text-[3rem] text-[5rem] md:text-[10rem] absolute transition-opacity duration-500 opacity-100 bg-gradient-to-r from-pongblue via-[rgba(100,100,255,0.8)] to-pongblue text-transparent bg-clip-text drop-shadow-[0_0_15px_#00f7ff]"></i>
			...
			<div class="relative w-full h-[4rem] sm:h-[8rem] flex items-center justify-center">
				<i id="icon-online" class="fa-solid fa-globe max-[460px]:text-[3rem] text-[5rem] md:text-[10rem] absolute transition-opacity duration-500 opacity-100 bg-gradient-to-b from-pongblue via-[rgba(100,100,255,0.8)] to-pongblue text-transparent bg-clip-text drop-shadow-[0_0_15px_#00f7ff]"></i>
