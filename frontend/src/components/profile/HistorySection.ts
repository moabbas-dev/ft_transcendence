...
export const HistorySection = createComponent((props: HistorySectionProps) => {
	...
	container.innerHTML = `
		...
		<td class="px-3 py-2 lg:px-6 lg:py-4 text-center whitespace-nowrap">${props.resPlayer} - ${props.resOpponent}</td>
		<td class="px-3 py-2 lg:px-6 lg:py-4 text-center whitespace-nowrap">${outcome}</td>
